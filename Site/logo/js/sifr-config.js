...
sIFR.replace(websitename, {
  selector: '#textlogo',
  css: '.sIFR-root a { background:transparent; color: #ffcc33; padding:10px;  font-size:60px; cursor:pointer; font-weight:normal; text-decoration:none; text-align:left; text-indent:10px;}.sIFR-root a:hover {  color: #ffffff;}.sIFR-root { background:transparent; color: #FF9933; padding:10px;  font-size:60px; cursor:pointer; font-weight:bold; text-decoration:none; text-align:center; text-indent:10px;}',
  wmode: 'transparent',
  filters: {
 	 GradientBevelFilter:{ 
		distance:8,
